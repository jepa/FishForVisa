...
## Create Transboundary Catch Database
...
label_data <- Continent_Data_Trans %>% 
  ...
  mutate(
    sub_region = ifelse(str_detect(sub_region,"Latin"),"Latin America &\nthe Caribbean",
...
# Revenue Plot
# Set plot limits
min_lim <- min(Continent_Data_Trans$Total_USD)
...
Rev_Plot <- ggplot(data = Continent_Data_Trans, 
  ...
  theme(
    ...
    plot.margin = margin(0,-10,-5,-10,"cm")
  )  +
  # Base line
  ...
  geom_text(data=label_data, 
            ...
            inherit.aes = FALSE) +
  scale_fill_gradientn("Billion USD",
                       colours = pal)
...
plot <- ggdraw() +
  ...
  # Revenue circular
  draw_plot(Rev_Plot, x = 0.1, y = 0.1, width = 0.5, height = 0.4) +
  # Catch circular
  draw_plot(Catch_Plot, x = 0.45, y = 0.1, width = 0.5, height = 0.4) +
...
# Plot_Name <- paste("100_25_Bins_Value_Region.png", sep = "") 
