...
```{r Find_Neighbours_sf, eval = F, echo =F}

#load North Carolia Data from sf
nc <- st_read(system.file("shape/nc.shp", package="sf"), quiet = TRUE)

# Get sparse matrix
int = st_intersects(nc)
...
matrix = data.frame(country = nc$NAME[mat[,1]], neighbor = nc$NAME[mat[,2]] )

# Remove duplicates... eg of course an object intersects with itself...
matrix = matrix[matrix$country != matrix$neighbor,]
