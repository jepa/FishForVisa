...
Species_Data <- Tresholded_T_Data %>% 
  ...
  mutate(DemersPelag = ifelse(is.na(DemersPelag),"Other",paste(DemersPelag)),
         ...
         Category == ifelse(DemersPelag %in% c("Developing","Rebuilding","Category A"),
                            ifelse(DemersPelag == "Max Exploitation","Category B",
                                   ifelse(DemersPelag %in% c("Overfished","Collapsed","Category C"),"Category C", "No Category")
                            )
         )
  ) %>% 
