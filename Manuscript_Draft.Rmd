...
Overall, we estimated **633** transboundary species in the world, more than double the number previously estimated [@Teh:2015gd], accounting for **65.4**% of the species analyzed (Fig. 1A). Between 2005 and 2014, national fleets targeting shared stocks within EEZs landed an average of **69.2** million tonnes, representing **64**% of the EEZ-global catch, and generating USD **79.7** million in fishing revenue, equivalent to **49.8**% of the total revenue of the same period. These values are higher than previously estimated [@Teh] and higlight the importance of these stocks at the global level. 

Transboundary species are particularly important at the regional and national level. In terms of catch and revenue, Eastern Asia and Latin America and the Caribbean are the higher zones (Fig 1B). Particular for counties in North America (Bermuda, Canada, Greenland, and the US), a moderate amount of catch (3.4 thousand tons) are worth 11.7 billion USD, highlighting the importance of transboundary species to the economy of the region. The EEZs along Western Eurpe, in turn, are home of **X** species responding to the joint fisheries management policy established by the European Union. In here, quotas are allocated by species and regulatory area [@Melnychuk:2017gh], making this region **unique** in terms of joint management of a high numer of shared stocks. 

At the country level, transboundary species are most valuable for the United States (USD 9,605 million), Russia (USD 6,361 million), China (USD 6,279 million) and Peru (USD 5,211). On the other hand, EEZs like that of Portugal, the Mediterranean side of Spain, Senegal, and the UK are rich in transboundary species (n > 110), but these do not represent a large amount of revenue, comparativeley. China, the world's top fish producer with 15.3 million tons landed in 2016 [@SOFIA2018], is the only country categorized high in both number of transboundary species (n = 119) and revenue. For the US, 16 species make up 90% of the revenue from transboudary species, with American scallop (*Placopecten magellanicus*) shared with Canada in Georges Bank [@https://elischolar.library.yale.edu/cgi/viewcontent.cgi?article=1008&context=fes-pubs] contributing 41.8% or the revenue. Russia shares the largest fished species in the world, Alaskan polllock (*Theragra chalcogramma*) [@SOFIA2018], with both Japan and the US. For Russia, this fishery is responsible for 50% of the revenue from transboundary species with other eight species comprising the 90% of revenue. In the case of Peru, Peruvian anchoveta (*Engraulis ringens*) and jumbo squid (*Dosidicus gigas*), both shared with Chile, represent almost 90% of the revenue from transboundary species, with anchoveta accounting for 79%.

These results hilights the importance of transboundary species not only at the global and regional levels, but also at the country level.



```{r Call_Map, eval = F, fig.width=6, fig.height=4, echo=FALSE, fig.pos= "H", fig.cap="A) Number of transboundary species per EEZ and they contribution to countries fishing revenue. The number of species is represented in the EEZ while the revenue is represented in the land polygon. B) Regional revenue (left) and catch (right) contribution of tranbsoundary species."}

img <- readPNG(here("./Figures/Fig1.png"))
grid.raster(img)
```

![**A) Number of transboundary species per EEZ and they contribution to countries fishing revenue. The number of species is represented in the EEZ while the revenue is represented in the land polygon. B) Regional revenue (left) and catch (right) contribution of tranbsoundary species.**](./Figures/Fig1.png)
