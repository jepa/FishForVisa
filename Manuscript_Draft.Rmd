...
Transboundary fisheries are vast in regions whith historic fisheries-related conflicts [@Spikjers]. Regional variation show higher frequency of transboundary species within EEZs along the South China sea, western central Atlantic, and the Mediterranean sea, followed by the Eastern north Atlantic (Fig 1). Some of these regions have been identified as most conflictive since 1970s with conflicts arrousing to even armed conflicts. Moreover, as climate change shifts species distributions and new transboundary species arrose [@Pinsky] as seen in past cases like the Pacific salmon [@REF], or the Macrrell waars [@Spijkers]. The joint management of shared stocks could be key to not only sustain fisheries into the future but also avoid international conflict [@REF]. 

Management of shared stocks have to be something. Although catch trends do not reflect stock status [@REf_Haters], they can inform provide a panoram of the situation when no other data is available [@Pauly]. In the case of transboundary species, we did not find a strong pattern suggesting a specific case (Fig 2).
