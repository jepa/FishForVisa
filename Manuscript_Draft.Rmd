...
We overlaid the known distribution of **968** commercially valuable marine species responsable for **%%** of global catch, and the EEZ of 153 coastal countries, and developed a four-criteria methodology to determine if a species was transboundary. First we only considered shared species between neighboring EEZs, rather than the species' extended distribution (e.g. we did not include the high seas). Secondly, we considered a species to be present in a grid cell if all data sources predicted positive occurrence (see Methods). The third criteria determined whether a species was exploited within a given grid cell using spatially explicit catch data. A species was considered as present in a grid cell if both predicted species occurrences and catch data were positive. Finally, we determined a spatial threshold based on the proportion of the species' distribution within each neighboring EEZs to confirm occurance in both EEZs. 

Once transboundary species were identified, we estimated their contribution to fisheries catch and revenues and categorized them according to catch trends. We define a ‘stock’ unit as a species in an EEZ, instead of using a population ecology definition (genetically or morphological distinct units) due to lack of such biological information for almost all the species included in this study [@Teh:2015gd]. While we acknowledge that a species could have multiple stocks within an EEZ, many fisheries within a country or EEZ are managed at the species instead of stock level. Also, recent research has suggested strong connectivity between stocks, even when separated by thousand of kilometers, **and providing additional ecological ground for...** [@Ramesh:2019va].

<!-- ## Results and discussion (~1000 words) -->

We identified **633** transboundary exploited species in the world, more than double of previous estimates [@Teh:2015gd], representing **65.4%** of the species analyzed (Fig. 1A). Between 2005 and 2014, national fleets targeting shared species within EEZs landed an average of **69.2** million tonnes, representing **64%** of the EEZ-derrived catches, and generating USD **79,745** million in fishing revenue. This is equivalent to **49.8%** of the global fishing revenue of the same period. These values are more than double the 34.2 million t and USD 30,700 million in fishing revenue previously estimated [@Teh:2015gd], underscoring the importance of transboundary species at the global level. 
...
Over 130 marine fish species occur in tropical and subtropical waters around the world [@Nelson:2016kk], many of which are highly migratory pelagic-oceanic species like skipjack tuna (*Katsuwonus pelamis*), other tunas (*Thunnus sp.*), sword fish (*Xiphias gladius*), and common dolphinfish (*Coryphaena hippurus*). Pelagic-oceanic species are the only group whose EEZ range (i.e., the number of EEZs where the species occur as 'transboundary') was significantly different from other species (one-way ANOVA *F*(5,109), *f* = 14.67, *p* < 0.001, $\alpha$ = 0.05; Tukey's post hoc test *p* < 0.05) with a median of 40 EEZs per species (Fig. 3). 
