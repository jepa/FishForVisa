...
Due to their large migration patterns and presence in areas beyond national jurisdiction, pelagic-oceanic species such as skipjack tuna (*Katsuwonus pelamis*), Common thresher shark (*Alopias vulpinus*), and tunas (*Thunnus sp.*) are catalogued as stradling species by FAO definitions and globally managed by Regional Fisheries Management Organizations (RFMOs) [@FAO]. Fifteen major RFMOs in the world oversee the management of 99 species, most of them fished in areas beyond national jurisdiction [@CullisSuzuki:2010fi]. We estimate that 81.8% of these species (*n* = 81) are actually shared within neighbouring RFMOs, with the International Commission for the Conservation of Atlantic Tunas (ICCAT) sharing over 40 species with neighbouring RFMOs (**Suplemental figure RFMO_MAP**). The catch from pelagic-oceanic species comes mainly from five South Pacific Islands nations, from which three (Kiribalti, Solomon and Papua New Guinea) are members of the Pacific Nauru Agreement (PNA) (Fig. 3B). The PNA manages 30% of global skipjack tuna [@Aqorau:2018bh], estimated to produce $2 billion worth of fish every year [@https://www.ffa.int/nauru_agreement]. 

The median for species of all other ecosystem preferences is close to, or less than, 20, as many of these might be cosmopolitan but not necessarily highly migratory (e.g. *Solea solea*, *Panulirus argus*) (Fig. 3). However, less distributed species must not be ignored. The world of fisheries is highly connected trough larvae dispersal [@Ramesh:2019va] and so, even centralized populations could be supplying populations thousands of kilometers away [@Ramesh:2019va]. Moreover, many coastal communities, specially in developing regions, and highly dependent on fishing local fish (e.g. reef fish) for food security and improved livelihoods [@CisnerosMontemayor:2016gq; Wabnitz:2018gf; @https://www.sciencedirect.com/science/article/pii/S0308597X17308357]. For example, from the top five countries fishing transboundary reef - associated species, Indonesia, Malaysia and the Philippines are among the higest fish consumption per capita in the world with 20, 60 and 40 kg per year, respectiveley [@https://www.sciencedirect.com/science/article/pii/S0308597X12001315]. 
...
**Suplemental figure Trans_Catch_MAP**
...
<!-- However, the effectiveness of RFMOs responsible for managing high migratory stocks, has been previously questioned [@CullisSuzuki:2010fi]. -->