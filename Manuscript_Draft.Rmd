...
The precense of a species in time and space is linked to a combination of biotic and abiotic factors, but the concept of species distribution is rarely integrated into fisheries management, or policy, .

Identifying what species re transboundary is a first step to the proper management of shared stocks and achieving sustainabillity of marine ressources.

Incorporating the concept of species distribution into fisheries management, or policy, is not allways hapens as shown by the delineation of Economic Exclusive Zones (EEZs) under the United Nations Convention on the Law of the Seas (UNCLOS) in the early 80s. Shared marine ressources are inheratably complex to manage and thus, require special care. However, forty years after the formal adoption of EEZs, the question of how many shared species exist in the world based on their distribution is still unanswered. Here, we ucombine species' distributions with the nation's EEZs in order to determine the number of transboundary stocks. moreover, we identify their importance in terms of catch and revenue and discuss the
