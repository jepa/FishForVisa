...
While these catch trends do not directly reflect stock status [@Branch:2011br] - e.g. other factors like markets, fishing policies or extreem events also influence catch volume [@PaulyNature2013] - they could ressemble fisheries that are over exploited or collapsed [@Kleisner:2011wn]. Empirical analysis suggest that management of transboundary species will have better outcomes in terms of fish yield and sustainabillity whith cooperation between nations [@REF]. Examples vary between regions and species including Mexico and the United States over Pacific anchovies [@CisnerosMontemayor:2020kv], Norway and Russia over Atlantic cod (*Gadus morhua*) [@Diekert:2010gp], and Namibia and South Africa over hake (*Merluccius spp*) [@Sumaila:2003vw].

Collaboration can also reduce conflict between nations over shared ressources. Transboundary fisheries are abundant and of economic importance for some of the top countries with past fisheries-related conflicts like Canada, the US, China and Russia [@Spijkers:2019cz]. For example, the United States and Canada had a dispute over Pacific salmons (*Oncorhynchus sp*) that lasted over 10 years and was only resolved after these two nations set a series of regulations to compensate losses [@Miller2003]. Since 2007, the European Union, Norway, Iceland, and the Faroe Islands have been at odds over the size and relative allocation of total allowable catches (TACs) for mackerel [@Spijkers:2017ij], a species that is transboundary and contributes **X** to landings and **X** in revenue to the countries involved in the dispute. In addition to past and present conflicts, climate change could exacerbate conflicts over transboundary species as climate change shifts the distribution of marine species around the globe [@Pinsky].
...
Species can have a cosmopolitan distribution, that is, a broader distribution, or be limited to a specific region, known as endemic [@NelsonFishesOfTheWorld]. Not surprisingly, highly migratory pelagic-oceanic species are the only group that significantly differs in terms of sharing countries (one-way ANOVA *F*(5,109), *f* = 14.67, *p* < 0.001, $\alpha$ = 0.05; Tukey's post hoc test *p* < 0.05) with a median of 40 nations sharing these resources (Fig. 3). 
...
Due to their large migration patterns and presence in areas beyond national jurisdiction, pelagic-oceanic species such as skipjack tuna (*Katsuwonus pelamis*), Common thresher shark (*Alopias vulpinus*), and tunas (*Thunnus sp.*) are catalogued as stradling species by FAO definitions and globally managed by Regional Fisheries Management Organizations (RFMOs) [@FAO]. Sixteen major RFMOs in the world oversee the management of 101 species, most of them fished in areas beyond national jurisdiction [@CullisSuzuki:2010fi]. We estimate that 56.4% of these species (*n* = 57) are actually shared by neighbouring RFMOs with the North Atlantic Salmon Conservation Organization (NASCO), the North East Atlantic Fisheries Commission (NASCO) and the International Commission for the Conservation of Atlantic Tunas (ICCAT) sharing over 30 species with neighbouring RFMOs (Suplemental figure RFMO_MAP).


The catch from these species comes mainly from five South Pacific Islands nations, from which three (Kiribalti, Solomon and Papua New Guinea) are members of the Pacific Nauru Agreement (PNA) (Fig. 3B). The PNA manages 30% of global skipjack tuna [@Aqorau:2018bh], estimated to produce $2 billion worth of fish every year [@https://www.ffa.int/nauru_agreement]. However, the effectiveness of RFMOs responsible for managing high migratory stocks, has been previously questioned [@CullisSuzuki:2010fi].



The median for species of all other ecosystem preferences is close to, or less than, 20, as many of these might be cosmopolitan but not necessarily highly migratory (e.g. *Solea solea*, *Panulirus argus*) (Fig. 3). However, less distributed species must not be ignored. The world of fisheries is highly connected trough larvae dispersal [@Ramesh:2019va] and so, even centralized populations could be supplying populations thousands of kilometers away [@Ramesh:2019va]. 

Moreover, many coastal communities, specially in developing regions, and highly dependent on fishing local fish (e.g. reef fish) for food security and improved livelihoods [@CisnerosMontemayor:2016gq; Wabnitz:2018gf; @https://www.sciencedirect.com/science/article/pii/S0308597X17308357]. For example, from the top five countries fishing transboundary reef - associated species, Indonesia, Malaysia and the Philippines are among the higest fish consumption per capita in the world with 20, 60 and 40 kg per year, respectiveley [@https://www.sciencedirect.com/science/article/pii/S0308597X12001315]. In the Phillipines...
