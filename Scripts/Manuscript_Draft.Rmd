...
# Data Availability
The Sea Around Us datasets used are publicly available at http://www.seaaroundus.org/, the occurrence dataset is all publicly available (see Methods), the ENM-Nereus data can be accessed upon request to G.R. The final dataset and code are available at https://github.com/jepa/FishForVisa
