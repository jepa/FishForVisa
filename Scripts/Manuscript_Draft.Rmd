...
**We identified 633 transboundary exploited species in the world (67.5% of the species analyzed), more than double the previous estimates [@Teh:2015gd].** Between 2005 and 2014, national fleets targeting transboundary species within EEZs **caught** an **anual** average of 47.6 million tons, representing 79.9% of the EEZ-derived catches reconstructed by the *Sea Around us* at the species level, and generating USD 65,483 million in fishing revenue. This is equivalent to 78.5% of the global fishing revenue of the same period. These values are more than the 34.2 million tons and USD 30,700 million in fishing revenue from shared stocks previously estimated [@Teh:2015gd]. **Such differences...**  

Based on our assessment (see Methods), 590 transboundary species were also identified as "discrete" species, meaning that the same species could be shared by two neighboring EEZs (transboundary) but not with a third neighbor (discrete). For example, Peruvian anchoveta (*Engraulis ringens*) is fished by Peru, Chile, and Ecuador but only transboundary between Peru and Chile, and thus discrete for Ecuador (**spatial treshold < 25%**). The **anual average contribution of discrete species between 2005 and 2014** was 14.8 million tons representing USD 22,167 million in fishing revenue **over the same time period**. Within these species, 305 were considered exclusively discrete, that is, they could be fished by neighboring nations but were not considered transboundary. These species represented only **an anual average of** 2.8 million tons and 3,691 million USD between 2005 and 2014. These results underscore the importance of transboundary species at the global level (Fig. 1).
...
**We determined the exploitation category of each species according to the catch trend within each EEZ (Fig. 3). While previous studies demonstrated that catch trends can be used to infer whether a stock is healthy, re-building, over-exploited or collapsed [@Kleisner:2011wn], several factors can influence stock status. Therefore, our intention here is not to infere stock status but to show the catch trend of transboundary species between 2005 and 2010. In this manner, fisheries under Category A have increased the catch, Category B have a constant catch rate, and Category C have seen a decrease in catch in same time period (See methods)**  We found significant differences in exploitation categories based on whether or not a species was transboundary (MANOVA, *Df*(2,447) = 27.091, *p* < 0.001). Specifically, transboundary species that are only fished by one country are generally less likely to be over-exploited compared to those shared by neighboring countries (Table S2). Significant differences were found for all categories within transboundary species (one-way ANOVA, *Df*(2,447) = 55.01, *p* $\leq$ 0.001, $\alpha$ = 0.05; Tukey's post hoc test *p* < 0.05) but only Category C for discrete species (one-way ANOVA, *Df*(2,380) = 21.86, *p* < 0.001; $\alpha$ = 0.05; Tukey's post hoc test for Categories C-A and C-B *p* < 0.001, and B-A 0.052). This result suggests that the management of discrete species could be better off as the variation between Categories A and B is closer (*p* = 0.052) than for transboundary species (*p* = 0.001).
...
![Figure 5. Number of shared species across RFMOs. Analysis included 99 species managed by Fourteen RFMOs according to Cullis-Suzuk and Pauly, 2010.](./Figures/Fig5.png)
