...
![Figure 3. Number of transboundary species by catch category. Category A, fishing between 10%-50% of maximum catch level after a drop larger than 10% of the recorded maximum catch; Category B, fishing over 50% of maximum catch level; Category C, fishing less than 50% of maximum catch](./Figures/Fig3.png)
...
Transboundary fisheries are abundant and of economic importance for some of the top countries with past fisheries-related conflicts including Canada, the USA, Russia and the European Union (EU) [@Spijkers:2019cz]. For example, since 2007, the EU, Norway, Iceland, and the Faroe Islands have been at odds over the size and relative allocation of total allowable catches for Atlantic mackerel (*Scomber scombrus*) due to a climate-driven distribution shift [@Spijkers:2017ij]. Mackerel is a transboundary species that contributed an average of 598.4 thousand tons to **total** catches (8.19% of total) and USD 850.2 million in **fishing** revenue (7.17% of total) to the countries involved in the dispute between 2005 and 2014. The relatively small contribution of mackerel to the involved countries suggests that even a small fraction of the year's catch can lead to important conflicts between neighboring countries. Climate change is expected to continue changing the distribution and share proportion of fish stocks among countries up to a degree that new transboundary species will emerge [@Pinsky:2018cb], while some species will exit EEZs [@Oremus:2020id]. Exploring the detailed impacts of climate change in share species is key to develop local adaptation methods to minimize the effect of such distributional change on the conservation of species as well as the economy and food security of coastal nations.
...
We estimated the economic contribution in **2020** [@REV] real USD of transboundary species for each country using global ex-vessel price data [@Tai2017]. The database we draw from includes ex-vessel price from multiple sources and a structured interpolation method (e.g. similar countries, species) to fill in data gaps [@Sumaila:2015uc]. The contribution of transboundary species was derived by aggregating the catch of species occurring within the EEZs of countries sharing that species. For this study, we did not include catch nor revenue from areas beyond national jurisdiction. 
