...
output:
  word_document:
    # reference_docx: ./Manuscript_Instructions/Science_Advances/SA.MS.Template_2018.docx
  pdf_document:
    fig_caption: yes
geometry: margin=1in
editor_options:
...
<!-- - Information to authors (https://advances.sciencemag.org/content/information-authors) -->
<!-- - Research articles: -->
...
![Fig. 3. Number of transboundary species by catch category. Category A, fishing between 10%-50% of maximum catch level after a drop larger than 10% of the recorded maximum catch; Category B, fishing over 50% of maximum catch level; Category C, fishing less than 50% of maximum catch](./Figures/Fig3.png)

## Transboundary species occurs at multiple ecosystem preferences 

We categorized species based on their habitat preference and found transboundary species in all cases (Fig 4.). However, species associated to pelagic-oceanic ecosystems are the only group whose EEZ range (i.e., the number of EEZs where the species occur as transboundary) was significantly different from other groups (one-way ANOVA; *DF*(5,597) = 53.82, *p* < 0.001, $\alpha$ = 0.05; Tukey's post hoc test *p* < 0.05) with a median of 40 EEZs per species. The median for species of all other ecosystem preferences is close to, or less than, 20, as many of these species have a narrower distribution or are less mobile (Fig. 3).
...
![Fig. 4. Number of EEZs shared by transboundary species. A) Number of EEZs by species organized by associated habitat according to FishBase. Showing only species that share > 20 EEZs. B) Catchs of main fishing countries fishing each ecosystem preference's top five species in terms of shared EEZs (shown in bold in A) between 2005 and 2014.](./Figures/Fig4.png)

Due to their large migration patterns and presence in areas beyond national jurisdiction, many highly migratory species are managed by Regional Fisheries Management Organizations (RFMOs). Fifteen major RFMOs in the world oversee the management of 99 species [@CullisSuzuki:2010fi]. When applying our analysis at the RFMO level (rather than EEZs), we found that 81.8% of the 99 species are shared across neighboring RFMOs, with the International Commission for the Conservation of Atlantic Tunas (ICCAT) sharing over 40 species with neighboring RFMOs (Fig. 5).
...
![Number of shared species across RFMOs. Analysis included with 99 species managed by Fourteen RFMOs](./Figures/Fig5.png)


# **Discussion**

Our study identified species currently shared by neighboring coastal nations and highlights the importance of these species' contribution to global capture and revenue from wild fisheries. The number of tranbsoundary species identified in this study are more than double the previous estimates [@Teh:2015gd]. Similarly, the catch and benefit from these species are more than the 34.2 million tons and USD 30,700 million in fishing revenue from shared stocks previously estimated [@Teh:2015gd]. These results underscore the importance of transboundary species at the global level. China, Japan, Peru, Russia and the USA are among the top seven mejor fishing producers of the world [@FAO:2018KK] and were identified as the nations who economically benefit the most from transboundary species. Peru and Russia, responsible for the two largest fisheries in the world [@FAO:2018KK], lead transboundary catch statistics harvesting over 5.8 million tons annually each on average between 2005 and 2014 (Fig S1). Peru's catches are mainly composed of Peruvian anchoveta (*Engraulis ringens*), shared with Chile, and account for 79% of the transboundary species production. Similarly, Russia shares the Alaskan pollock (*Theragra chalcogramma*) fishery with both Japan and the USA. Finally, when we account for the total area of waters in different EEZs and regions relative to their catches, the importance of transboundary species to Northern European fisheries become apparent. 

Many environmental and social-economic factors (e.g. temperature, markets, fishing policies) affect fishing effort and catch volume [@Pauly:2013gs; @Branch:2008kk]. Nevertheless, previous studies demonstrated that catch trends can be used to infer whether a stock is healthy, over-exploited or collapsed [@Kleisner:2011wn]. Following this concept, Category A would represent fisheries that are re-building or under-exploited, category B would be species that are sustainably harvested, and Category C would be species that are over-exploited. Our results suggests that the management of discrete species could be better off as the variation between Categories A and B are closer (p = 0.052) than for transboundary species (p = 0.002). Such result has direct implications for the management of transboundary species, suggesting an urgent need for strengthened international cooperation in the management of these fisheries. Empirical analysis suggests that cooperation in the management of transboundary stocks will have better outcomes, although there are specific cases where cooperation might not be the best strategy [@Munro:2002uf]. Examples of successful cooperative-management include Norway and Russia over Atlantic cod (*Gadus morhua*) [@Eide:2013dha] and Namibia and South Africa over hake (*Merluccius spp*) [@Sumaila:2003vw]. Lack of collaboration over shared stocks may threaten stock sustainability, reduce the future profitability potential of the fishery, and create conflict between neighboring nations [@Clark:1980js; @Spijkers:2017ij]. 

Transboundary fisheries are abundant and of economic importance for some of the top countries with past fisheries-related conflicts including Canada, the USA, Russia and the European Union (EU) [@Spijkers:2019cz]. For example, since 2007, the EU, Norway, Iceland, and the Faroe Islands have been at odds over the size and relative allocation of total allowable catches for Atlantic mackerel (*Scomber scombrus*) due to a climate-driven distribution shift [@Spijkers:2017ij]. Mackerel is a transboundary species that contributed an average of 598.4 thousand tons to catches (8.19% of total) and USD 850.2 million in revenue (7.17% of total) to the countries involved in the dispute between 2005 and 2014. The relatively small contribution of mackerel to the involved countries suggests that even a small fraction of the year's catch can lead to important conflicts between neighboring countries. Collaboration can also reduce conflict between nations over shared resources as climate change continues changing the distribution and share proportion of fish stocks among countries. Marine species distributions are expected to change up to a degree that new transboundary species will emerge [@Pinsky:2018cb], while some species will exit EEZs [@Oremus:2020id]. Exploring the detailed impacts of climate change in share species is key to develop local adaptation methods to minimize the effect of such distributional change on the conservation of species as well as the economy and food security of coastal nations.

Over 130 marine fish species occur in tropical and subtropical waters around the world [@Nelson:2016kk], from highly migratory species associated to pelagic-oceanic ecosystems like tunas (*Thunnus sp.*), to less mobile reef-associated species like greater amberjack (*Seriola dumerili*), to species found in demersal ecosystems like gilthead seabream (*Sparus aurata*). We found transboundary species regardless of the ecosystem preference, althou pelagic-oceanic species were dominant. These species are mostly managed by RFMOs whos effectiveness of has been previously questioned [@CullisSuzuki:2010fi]. However, despite a global expansion of the industrial fleet in the last decade [@Coulter:2020gr], a recent analysis of 40 tuna and billfish stocks suggests that most stocks are sustainable harvested with only three currently considered as overfished [@Pons:2016ep]. In the other hand, species with narrower ranges (e.g. reef-associated species) are often managed at the national level due to localized populations [@Payne:2008vm]. However, the potential boundary-crossing of these species must not be ignored. The world of fisheries is highly connected through larvae dispersal and so, even centralized populations could be supplying populations thousands of kilometers away [@Ramesh:2019va]. In addition, coral regions often share multiple species, making coordination among countries key to achieve fisheries and conservation goals [@Payne:2008vm]. Many coastal communities, particularly in developing regions, are highly dependent on subsistence fishing for food security and livelihoods [@CisnerosMontemayor:2016gq; @Wabnitz:2018gf]. For example, all of the top five countries fishing transboundary reef and pelagic-oceanic associated species (Fig. 3B) are among the highest fish consumption countries [@FAO:2018KK]. In these countries, both pelagic and reef fishes contribute substantially to both local food security and livelihood [@Cabral:2018hc]. In the case of Kiribati, the Solomon Islands and Papua New Guinea, they are parties to the Pacific Nauru Agreement that sustainable manage 30% of global skipjack tuna [@Aqorau:2018bh], estimated to produce $2 billion worth of fish every year, representing a role model for transboundary fisheries management [@Hanich:2010ht].

<!-- Conclussion -->
Our results show that captures and revenues from shared species are substantially higher than those from discrete species, as well as than previously estimated. This result highlights the importance of transboundary fisheries and their potential contribution to food security and wellbeing. Moreover, we show significant differences in the management of transboundary and discrete species, suggesting a need for improving the management of transboundary fisheries. Previous work has found that collaboration will result in better outcomes for shared marine resources [@Munro:2002uf]. Thus, countries should pay specific attention in the management of the identified transboundary stocks potentially creating collaborative management plans. Identifying existing transboundary species is the first step towards joint management frameworks that are precautionary, strive for sustainability, and can be flexible to accommodate the uncertain future driven by climate change.

<!-- Key uncertainties -->
We have identified four key uncertainties in the method that may affect the estimation of transboundary stocks (see Methods). Firstly, we define a ‘stock’ unit as a species in an EEZ, instead of using a population ecology definition (genetically or morphological distinct units) due to lack of such biological information for almost all the species included in this study. Secondly, the predicted species distribution is affected by the uncertainties of the environmental data and models used for such predictions. Thus, we used multiple sources to determine species' distribution and followed an agreement method between sources to reduce uncertainty. Thirdly, we assumed that, if the Sea Around Us reconstructed data recorded a species as caught in any given grid cell, then the species was present within that grid cell. We only used this dataset due to the lack of other comparable bases. Finally, the results of this study only considered those species that had a *Species Index* of 1 (e.g. all datasets agree on presence) and at least 25% of *Area Index* (e.g. the species shared distribution was at least 25% in each EEZ). These selection presents a relative conservative estimate of the number of transboundary species in the world. 
...
We thank T. Clark and A. Tidd for helpful comments and discussions. **Funding**: G.R. was supported by the EO Wilson foundation. C.W. was supported by the Walton Family Foundation (grant 2018-1371), the David and Lucile Packard Foundation (grant 2019-68336), and the Gordon and Betty Moore Foundation (grant GBMF5668.02). W.W.L.C was supported by the NSERC Discovery Grant and the SSHRC Partnership. **Authors contributions**: J.P.A. Conceptualization, methodology, formal analysis, writing original draft. G.R. Methodology, data curation, writing - review & editing. C.W. Methodology, writing - review & editing. W.W.L.C. Supervision, writing - review & editing. All authors provided valuable input to the study conceptualization and discussed the results and analysis. **Competing interests**: No declared. **Data and materials availability**: The Sea Around Us datasets used are publicly available at http://www.seaaroundus.org/, the occurrence dataset is all publicly available (see Methods), the ENM-Nereus data can be accessed upon request to G.R. All code is available at https://github.com/jepa/FishForVisa

## Data and materials availability
All data is publicly available online and upon request from the authors.

## List of Supplementary Materials
Figures S1-S4
Tables S1 -S2
References in main manuscript (1-27)
