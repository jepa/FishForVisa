...
## Questions for Gabs:
- Occurence data time frame
- ESM is 1970 to 2000, is this beacuse of cliamte period? Reference?
- SAU-SDM is only one file right, there are no historic estimations
- **Rev 1.** Line 132: Why? These last sentence is hard to understand. 

## Questions for William:
- I want to reference both Ocean Canada papers to address a comment, is it fair to reference them as *in press*?
...
![Figure 3. Number of transboundary species by catch category. Actegory A, Increasing catch; Category B, stable catch; Category C, decreasing catch](../Figures/Fig3.png)
...
![Figure S2. Histogram of number of transboundary species using different Area Index threshold values. The darker histogram represents the threshold (25%) used in the present analysis](./Figures/FigS4.png)
