...
```{r TableS1, eval = T, echo = F}

read.csv("../Tables/Table_S1.csv") %>% 
  clean_names() %>% 
...
```{r TableS2, eval = T, echo = F, message = F, warning = F}
