...
```{r CallSup2, eval = T, fig.width=6, fig.height=9, echo=FALSE, fig.pos= "H", fig.cap=" Histogram of number of transboundary species using different Area Index threshold values. The darker histogram represents the threshold (25%) used in the present analysis. Figure created using R version 3.5.2."}
